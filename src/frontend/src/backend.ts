...
export class Backend implements backendInterface {
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string, arg3: ServiceType, arg4: string, arg5: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactForm(arg0, arg1, arg2, to_candid_ServiceType_n6(this._uploadFile, this._downloadFile, arg3), arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    residentialCleaning: null;
} | {
    carpetCleaning: null;
}): ServiceType {
    return "windowCleaning" in value ? ServiceType.windowCleaning : "commercialCleaning" in value ? ServiceType.commercialCleaning : "other" in value ? ServiceType.other : "residentialCleaning" in value ? ServiceType.residentialCleaning : "carpetCleaning" in value ? ServiceType.carpetCleaning : value;
}
...
function to_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceType): {
    ...
    return value == ServiceType.windowCleaning ? {
        windowCleaning: null
    } : value == ServiceType.commercialCleaning ? {
        commercialCleaning: null
    } : value == ServiceType.other ? {
        other: null
    } : value == ServiceType.residentialCleaning ? {
        residentialCleaning: null
